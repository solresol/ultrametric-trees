...
func LoadContextNWithinNode(db *sql.DB, dataframeTable string, nodeBucketTable string, nodeID int, k int, contextLength int) ([]DataFrameRow, error) {
	...
	for rows.Next() {
		...
		// Conversion from Synsetpath to DataFrameRow's TargetWord field
