...
sense-annotated-training-dataframe.sqlite: bin/prepare $(SENSE_ANNOTATED_TRAINING_DATA)
	...
	$(error "The file $(SENSE_ANNOTATED_TRAINING_DATA) does not exist. Please verify the file path or ensure the file is available. If the file is missing, you can obtain it by following the instructions in the project documentation or contacting the project maintainer. Once obtained, place it in the directory specified by the SENSE_ANNOTATED_TRAINING_DATA variable in this Makefile.")
endif
